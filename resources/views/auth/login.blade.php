            ...
            <div class="col-md-9 height-full css-selector d-flex align-content-center flex-wrap">
                <div class="col-md-6">
                    <div class="text-white p-l-80">
                        <p class="fs-50 mb-4 font-weight-light">PUNDI</p>
                        <span class="fs-25 font-weight-lighter">Pegiat Pendidikan Indonesia.</span>
                        <br>
                        <span class="fs-25 font-weight-lighter">kanal pendidikan tajam dan mencerahkan.</span>
                        <hr class="mt-2 bg-white" width="200%">
                    </div>
                </div>
                <div class="absolute bottom-0 text-white m-l-90 mb-5">COPYRIGHT © 2021.</div>
            </div>
            <div class="col-md-3 white">
                <div class="pl-5 pt-5 pr-5 m-t-90 pb-0">
                    <img src="{{ asset('images/template/'.$template->logo) }}" class="mx-auto d-block" width="130" alt=""/>
                </div>
                <div class="p-5">
